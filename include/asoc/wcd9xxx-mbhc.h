...
struct wcd9xxx_mbhc_config {
	...
	int (*mclk_cb_fn)(struct snd_soc_component *component, int on, bool enable);
...
struct wcd9xxx_mbhc_cb {
	void (*enable_mux_bias_block)(struct snd_soc_component *component);
	void (*cfilt_fast_mode)(struct snd_soc_component *component, struct wcd9xxx_mbhc *mbhc);
	void (*codec_specific_cal)(struct snd_soc_component *component,
				    struct wcd9xxx_mbhc *mbhc);
	struct wcd9xxx_cfilt_mode (*switch_cfilt_mode)(struct wcd9xxx_mbhc *mbhc,
							bool enable);
	void (*select_cfilt)(struct snd_soc_component *component, struct wcd9xxx_mbhc *mbhc);
	enum wcd9xxx_cdc_type (*get_cdc_type)(void);
	void (*enable_clock_gate)(struct snd_soc_component *component, bool enable);
	int (*setup_zdet)(struct wcd9xxx_mbhc *mbhc,
			   enum mbhc_impedance_detect_stages stage);
	void (*compute_impedance)(struct wcd9xxx_mbhc *mbhc, s16 *l, s16 *r,
				   uint32_t *zl, uint32_t *zr);
	void (*zdet_error_approx)(struct wcd9xxx_mbhc *mbhc, uint32_t *zl,
				    uint32_t *zr);
	void (*enable_mbhc_txfe)(struct snd_soc_component *component, bool enable);
	int (*enable_mb_source)(struct snd_soc_component *component, bool turn_on, bool enable);
	void (*setup_int_rbias)(struct snd_soc_component *component, bool enable);
	void (*pull_mb_to_vddio)(struct snd_soc_component *component, bool enable);
	bool (*insert_rem_status)(struct snd_soc_component *component);
	void (*micbias_pulldown_ctrl)(struct wcd9xxx_mbhc *mbhc, bool enable);
	int (*codec_rco_ctrl)(struct snd_soc_component *component, bool enable);
	void (*hph_auto_pulldown_ctrl)(struct snd_soc_component *component, bool enable);
	struct firmware_cal * (*get_hwdep_fw_cal)(struct snd_soc_component *component,
				enum wcd_cal_type);
};
...
struct wcd9xxx_mbhc {
	...
	bool micbias_enable;
	int (*micbias_enable_cb)(struct snd_soc_component *component,  bool enable,
				  enum wcd9xxx_micbias_num);
