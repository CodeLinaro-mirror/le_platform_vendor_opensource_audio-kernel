...
struct wcd9xxx_mbhc_config {
	...
	int (*mclk_cb_fn) (struct snd_soc_component *component, int, bool);
...
struct wcd9xxx_mbhc_cb {
	...
	void (*cfilt_fast_mode) (struct snd_soc_component *component, struct wcd9xxx_mbhc *);
	...
	struct wcd9xxx_cfilt_mode (*switch_cfilt_mode) (struct wcd9xxx_mbhc *,
							bool);
	void (*select_cfilt) (struct snd_soc_component *component, struct wcd9xxx_mbhc *);
	enum wcd9xxx_cdc_type (*get_cdc_type) (void);
	void (*enable_clock_gate) (struct snd_soc_component *component, bool);
	...
	void (*zdet_error_approx) (struct wcd9xxx_mbhc *, uint32_t *,
				    uint32_t *);
	void (*enable_mbhc_txfe) (struct snd_soc_component *component, bool);
	int (*enable_mb_source) (struct snd_soc_component *component, bool, bool);
	void (*setup_int_rbias) (struct snd_soc_component *component, bool);
	void (*pull_mb_to_vddio) (struct snd_soc_component *component, bool);
	bool (*insert_rem_status) (struct snd_soc_component *component);
	void (*micbias_pulldown_ctrl) (struct wcd9xxx_mbhc *, bool);
	int (*codec_rco_ctrl) (struct snd_soc_component *component, bool);
	void (*hph_auto_pulldown_ctrl) (struct snd_soc_component *component, bool);
