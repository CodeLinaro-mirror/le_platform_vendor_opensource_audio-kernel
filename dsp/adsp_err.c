...
#define VPM_EFAILED_STR       "VPM_EFAILED"
#define VPM_EALREADY_STR      "VPM_EALREADY"
#define VPM_ENORESOURCE_STR   "VPM_ENORESOURCE"
#define VPM_EBADPARAM_STR     "VPM_EBADPARAM"
#define VSM_EFAILED_STR       "VSM_EFAILED"
#define VSM_EALREADY_STR      "VSM_EALREADY"
#define VSM_ENORESOURCE_STR   "VSM_ENORESOURCE"
#define VSM_EBADPARAM_STR     "VSM_EBADPARAM"
...
static struct adsp_err_code adsp_err_code_info[ADSP_ERR_MAX+1] = {
	...
	{ -ECONNREFUSED, VPM_EFAILED_STR},
	{ -EEXIST, VPM_EALREADY_STR},
	{ -ENOSPC, VPM_ENORESOURCE_STR},
	{ -EBADRQC, VPM_EBADPARAM_STR},
	{ -ECONNABORTED, VSM_EFAILED_STR},
	{ -EISCONN, VSM_EALREADY_STR},
	{ -ENOSR, VSM_ENORESOURCE_STR},
	{ -EBADR, VSM_EBADPARAM_STR},
	{ -EADV, ADSP_ERR_MAX_STR},
};
