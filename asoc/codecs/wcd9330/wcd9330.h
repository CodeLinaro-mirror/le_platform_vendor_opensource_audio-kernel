...
extern int tomtom_mclk_enable(struct snd_soc_component *component, int mclk_enable,
			     bool dapm);
extern int tomtom_codec_mclk_enable(struct snd_soc_component *component,
				    int mclk_enable, bool dapm);
extern int tomtom_hs_detect(struct snd_soc_component *component,
			   struct wcd9xxx_mbhc_config *mbhc_cfg);
extern void tomtom_hs_detect_exit(struct snd_soc_component *component);
extern void *tomtom_get_afe_config(struct snd_soc_component *component,
...
extern void tomtom_register_ext_clk_cb(
	...
	struct snd_soc_component *component);
extern int tomtom_enable_qfuse_sensing(struct snd_soc_component *component);
