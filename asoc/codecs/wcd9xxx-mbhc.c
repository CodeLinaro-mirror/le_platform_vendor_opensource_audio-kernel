...
{
	return snd_soc_component_read32(mbhc->component, WCD9XXX_A_CDC_MBHC_EN_CTL) & 0x1;
}
				     ...
				     bool checkpolling)
{
	...
	if (vddio_switch && !mbhc->mbhc_micbias_switched &&
		...
		override = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_CTL) &
			   0x04;
		if (!override)
					    ...
					    bool fast)
{
	...
	if (mbhc->mbhc_cb && mbhc->mbhc_cb->switch_cfilt_mode) {
		...
		cfilt_mode.cur_mode_val =
		    snd_soc_component_read32(component, mbhc->mbhc_bias_regs.cfilt_ctl) & 0x40;
	}
...
static void wcd9xxx_clr_and_turnon_hph_padac(struct wcd9xxx_mbhc *mbhc)
{
	...
	wg_time = snd_soc_component_read32(component, WCD9XXX_A_RX_HPH_CNP_WG_TIME);
	wg_time += 1;
...
static bool wcd9xxx_is_hph_dac_on(struct snd_soc_component *component, int left)
{
	u8 hph_reg_val = 0;
	if (left)
		hph_reg_val = snd_soc_component_read32(component, WCD9XXX_A_RX_HPH_L_DAC_CTL);
	else
		hph_reg_val = snd_soc_component_read32(component, WCD9XXX_A_RX_HPH_R_DAC_CTL);
...
{
	u8 hph_reg_val = 0;
	hph_reg_val = snd_soc_component_read32(component, WCD9XXX_A_RX_HPH_CNP_EN);
...
static short wcd9xxx_read_sta_result(struct snd_soc_component *component)
{
	...
	bias_msb = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B3_STATUS);
	bias_lsb = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B2_STATUS);
...
static short wcd9xxx_read_dce_result(struct snd_soc_component *component)
{
	...
	bias_msb = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B5_STATUS);
	bias_lsb = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B4_STATUS);
	bias_value = (bias_msb << 8) | bias_lsb;
	return bias_value;
}
				   ...
				   bool norel)
{
	...
	override_bypass = (snd_soc_component_read32(mbhc->component,
				...
				bool is_cs_enable)
{
	...
	cfilt_mode = snd_soc_component_read32(component, mbhc_micb_regs->cfilt_ctl);
				...
				bool is_cs_enable)
{
	...
	if (mbhc->mbhc_cfg->do_recalibration) {
		...
		reg = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_CTL);
		...
		if (is_cs_enable) {
			...
			reg = snd_soc_component_read32(mbhc->component,
					   WCD9XXX_A_CDC_MBHC_B1_CTL);
...
static int wcd9xxx_hphl_status(struct wcd9xxx_mbhc *mbhc)
{
	...
	WCD9XXX_BCL_ASSERT_LOCKED(mbhc->resmgr);
	hph = snd_soc_component_read32(component, WCD9XXX_A_MBHC_HPH);
	...
	status = snd_soc_component_read32(component, WCD9XXX_A_RX_HPH_L_STATUS);
...
static int wcd9xxx_pull_down_micbias(struct wcd9xxx_mbhc *mbhc, int us)
{
	 ...
	 */
	if ((snd_soc_component_read32(mbhc->component, ctlreg) & 0x01)) {
		WARN_ONCE(1, "MBHC micbias is already pulled down unexpectedly\n");
		return -EFAULT;
	}

	if ((snd_soc_component_read32(mbhc->component, WCD9XXX_A_MAD_ANA_CTRL) & 1 << 4)) {
		snd_soc_component_update_bits(mbhc->component, WCD9XXX_A_MAD_ANA_CTRL,
				    1 << 4, 0);
		micbiasconn = true;
	}
...
wcd9xxx_codec_get_plug_type(struct wcd9xxx_mbhc *mbhc, bool highhph)
{
	...
	WARN_ON(!(snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_CTL) & 0x04));
...
{
	return !!(snd_soc_component_read32(component, WCD9XXX_A_CDC_CLK_MCLK_CTL) & 0x05);
}
				    ...
				    int insertion, int trigger, bool padac_off)
{
	...
	if (snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_CTL) & 0x4) {
		/* called by interrupt */
	...
	if (!(snd_soc_component_read32(component, WCD9XXX_A_PIN_CTL_OE1) & 1)) {
	...
	/* If LDO_H disabled */
	if (snd_soc_component_read32(component, WCD9XXX_A_PIN_CTL_OE0) & 0x80) {
...
static bool wcd9xxx_detect_anc_plug_type(struct wcd9xxx_mbhc *mbhc)
{
	...
	override_en = (snd_soc_component_read32(mbhc->component, WCD9XXX_A_CDC_MBHC_B1_CTL) &
		       0x04) ? true : false;
...
static irqreturn_t wcd9xxx_hs_insert_irq(int irq, void *data)
{
	...
	is_mb_trigger = !!(snd_soc_component_read32(component, mbhc->mbhc_bias_regs.mbhc_reg) &
			   0x10);
	is_removal = !!(snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_INT_CTL) & 0x02);
...
static void wcd9xxx_swch_irq_handler(struct wcd9xxx_mbhc *mbhc)
{
	...
	if ((mbhc->current_plug == PLUG_TYPE_NONE) && insert) {
		...
		if ((mbhc->current_plug != PLUG_TYPE_NONE) &&
		    (mbhc->current_plug != PLUG_TYPE_HIGH_HPH) &&
		    !(snd_soc_component_read32(component, WCD9XXX_A_MBHC_INSERT_DETECT) &
				   (1 << 1))) {
			  ...
			  bool norel_detection)
{
	...
	reg0 = snd_soc_component_read32(component, micb_regs->ctl_reg);
	snd_soc_component_update_bits(component, micb_regs->ctl_reg, 0x81, 0x1);
	reg1 = snd_soc_component_read32(component, micb_regs->mbhc_reg);
...
irqreturn_t wcd9xxx_dce_handler(int irq, void *data)
{
	...
	mbhc_status = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_STATUS) & 0x3E;
...
static void wcd9xxx_mbhc_cal(struct wcd9xxx_mbhc *mbhc)
{
	...
	cfilt_mode = snd_soc_component_read32(component, mbhc->mbhc_bias_regs.cfilt_ctl);
	if (mbhc->mbhc_cb && mbhc->mbhc_cb->cfilt_fast_mode)
		mbhc->mbhc_cb->cfilt_fast_mode(component, mbhc);
	else
	...
	reg0 = snd_soc_component_read32(component, mbhc->mbhc_bias_regs.ctl_reg);
	snd_soc_component_update_bits(component, mbhc->mbhc_bias_regs.ctl_reg, 1, 1);
	/* Disconnect override from micbias */
	reg1 = snd_soc_component_read32(component, WCD9XXX_A_MAD_ANA_CTRL);
	...
	reg2 = snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_CTL);
	snd_soc_component_update_bits(component, WCD9XXX_A_CDC_MBHC_B1_CTL, 0x78,
				...
				void *data)
{
	...
	case WCD9XXX_EVENT_POST_MICBIAS_4_OFF:
		...
		if (mbhc->micbias_enable && mbhc->polling_active &&
		    !(snd_soc_component_read32(mbhc->component, mbhc->mbhc_bias_regs.ctl_reg)
		    & 0x80)) {
	...
	case WCD9XXX_EVENT_PRE_HPHL_PA_ON:
		...
		if (!(snd_soc_component_read32(component, mbhc->mbhc_bias_regs.ctl_reg) & 0x80))
	...
	case WCD9XXX_EVENT_PRE_TX_3_ON:
		...
		if (!(snd_soc_component_read32(component, mbhc->mbhc_bias_regs.ctl_reg)
		      & 0x80) &&
...
//	mutex_lock(&codec->mutex);
	 ...
	 */
	micb_mbhc_val = snd_soc_component_read32(component, WCD9XXX_A_MAD_ANA_CTRL);
	snd_soc_component_update_bits(component, WCD9XXX_A_MAD_ANA_CTRL,
			    0x10, 0x00);

	override_en = (snd_soc_component_read32(component, WCD9XXX_A_CDC_MBHC_B1_CTL) & 0x04) ?
					true : false;
	if (!override_en)
		wcd9xxx_turn_onoff_override(mbhc, true);
